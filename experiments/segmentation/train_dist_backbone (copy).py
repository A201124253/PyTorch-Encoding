...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--transfer', action='store_true', default= False,
                            help='using clasification model to do transfer learning')                    
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = get_segmentation_model(args.model, dataset=args.dataset,
                                   ...
                                   base_size=args.base_size, crop_size=args.crop_size, transfer=args.transfer,
                                   **model_kwargs)
    # print(torch.load("/home/lzj/.encoding/models/deepten_resnet50_minc-1225f149.pth"))
    # if args.transfer:
    #     model.load_state_dict(torch.load("/home/lzj/.encoding/models/deepten_resnet50_minc-1225f149.pth", map_location='cpu'),strict=False)
