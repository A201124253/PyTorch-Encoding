...
class MINCSegmentation(BaseDataset):
    BASE_DIR = 'minc_dataset'
    NUM_CLASS = 23
    def __init__(self, root=os.path.expanduser('~/.encoding/data/'), split='train',
                 mode=None, transform=None, target_transform=None, **kwargs):
        super(MINCSegmentation, self).__init__(
        ...
        self.images, self.masks = _get_minc_pairs(root, split)
        if split != 'test':
...
def _get_minc_pairs(folder, split='train'):
